...
final class Schema16 extends i0.VersionedSchema {
  ...
  late final Shape42 swaps = Shape42(
    source: i0.VersionedTable(
      entityName: 'swaps',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape43 getPaidSettings = Shape43(
    source: i0.VersionedTable(
      ...
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(id)'],
      columns: [_column_254, _column_255, _column_256],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape44 frozenUtxos = Shape44(
    source: i0.VersionedTable(
      entityName: 'frozen_utxos',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(wallet_id, tx_id, vout)'],
      columns: [_column_161, _column_257, _column_258],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape43 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get automatedBackupEnabled =>
      columnsByName['automated_backup_enabled']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get backupDisclosureAcknowledged =>
      columnsByName['backup_disclosure_acknowledged']!
...
final class Schema17 extends i0.VersionedSchema {
  ...
  late final Shape45 paymentRecoveries = Shape45(
    source: i0.VersionedTable(
      entityName: 'payment_recoveries',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(invoice_id)'],
      columns: [
        _column_259,
        _column_260,
        _column_261,
...
class Shape45 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get invoiceId =>
      columnsByName['invoice_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get nym =>
      columnsByName['nym']! as i1.GeneratedColumn<String>;
  ...
  i1.GeneratedColumn<String> get refundTxid =>
      columnsByName['refund_txid']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get lockupAddress =>
      columnsByName['lockup_address']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get amountSat =>
      columnsByName['amount_sat']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get fiatCurrency =>
      columnsByName['fiat_currency']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get fiatAmountMinor =>
      columnsByName['fiat_amount_minor']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get detectedAtUnix =>
      columnsByName['detected_at_unix']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get lastAttemptAtUnix =>
      columnsByName['last_attempt_at_unix']! as i1.GeneratedColumn<int>;
  ...
  i1.GeneratedColumn<int> get acknowledged =>
      columnsByName['acknowledged']! as i1.GeneratedColumn<int>;
}
