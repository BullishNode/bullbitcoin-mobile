    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          if (!snapshot.isFiatFixed && snapshot.lightningPr != null)
            _copyBlock(
              context,
              context.loc.invoicePaymentLightningLabel,
              snapshot.lightningPr!,
            ),
          if (!snapshot.isFiatFixed && snapshot.liquidAddress != null)
            _copyBlock(
              context,
              context.loc.invoicePaymentLiquidLabel,
              snapshot.liquidAddress!,
            ),
          if (!snapshot.isFiatFixed && snapshot.bitcoinAddress != null)
            _copyBlock(
              context,
    ...
    return Column(
      ...
      children: [
        ...
        if (quote != null && usable) ...[
          ...
          _copyBlock(
            context,
            _paymentRailTitle(context, quote.selectedRail),
            quote.instruction.copyPayload,
          ),
