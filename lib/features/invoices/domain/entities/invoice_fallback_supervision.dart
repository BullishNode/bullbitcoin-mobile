...
/// The minimum invoice projection carried with every fallback incident. It
/// lets the invoices list expose an incident even when the ordinary invoice
/// page does not contain that invoice.
class InvoiceFallbackInvoiceContext {
  ...
  const InvoiceFallbackInvoiceContext({
...
class InvoiceFallbackSupervision {
  ...
  final InvoiceFallbackInvoiceContext? invoiceContext;
