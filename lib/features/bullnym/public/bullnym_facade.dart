...
class BullnymFacade {
  ...
  const BullnymFacade({
    required RegisterBullnymUsecase register,
    required DeleteBullnymRegistrationUsecase deleteRegistration,
    required LookupBullnymRegistrationUsecase lookupRegistration,
  }) : _register = register,
