...
Restoring a Lightning Address wallet materialization restores local wallets only; the BIP85 reservation policy marks it as `requiresProductReactivation` because Bullnym registration must be checked or recreated by Lightning Address.
