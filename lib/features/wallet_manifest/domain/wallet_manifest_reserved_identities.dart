...
WalletManifestWalletType classifyWalletManifestIdentity({
  ...
  if (bip85Index == WalletManifestReservedBip85Indexes.lightningAddress &&
      network.isLiquid) {
    return WalletManifestWalletType.lightningAddress;
  }
  if (bip85Index == WalletManifestReservedBip85Indexes.paymentPage &&
      network.isLiquid) {
    return WalletManifestWalletType.paymentPage;
  }
  if (bip85Index == WalletManifestReservedBip85Indexes.btcpay) {
