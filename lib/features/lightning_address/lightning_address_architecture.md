...
Recovery reads Bullnym again. An offline permanent-name registration remains offline until an explicit user action; recovery never silently turns it back on. The local manifest restores wallet materialization metadata but is not an ownership or product-availability record.
