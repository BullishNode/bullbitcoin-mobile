...
- domain use cases for prepare wallet, register, delete, lookup/status, wallet-owned registration/status composition, and wallet-owned activation composition;
