      ...
      body: SafeArea(
        child: BlocBuilder<LightningAddressCubit, LightningAddressState>(
          builder: (context, state) {
            ...
            // derivation and persists the Lightning Address receive wallet. On
                      ...
                      final confirmed =
                          await showDialog<bool>(
                            ...
                            builder: (ctx) => AlertDialog(
                              title: Text(
                                context.loc.lightningAddressDeactivateTitle,
                              ),
                              content: Column(
                                mainAxisSize: MainAxisSize.min,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
                                    context.loc.lightningAddressDeactivateBody(
                                      address,
                                    ),
                                  ),
                                  if (quotaState
                                      case QuotaState.lastSlot ||
                              ...
                              actions: [
                                TextButton(
                                  ...
                                  child: Text(
                                    context
                                        .loc
                                        .lightningAddressDeactivateCancel,
                                  ),
                                ),
                                TextButton(
                                  ...
                                  child: Text(
                                    context
                                        .loc
                                        .lightningAddressDeactivateConfirm,
                                    style: TextStyle(
                                      color: Theme.of(ctx).colorScheme.error,
                                    ),
                                  ),
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, i) => ListTile(
                      ...
                      title: Text('${nyms[i].nym}@$lightningAddressDomain'),
