...
const String walletMetadataRootDTagDerivationContext =
    'bullbitcoin.wallet_metadata.root.d.v1';
...
final class WalletMetadataKeyDeriver {
  ...
  String deriveRootDTag(WalletMetadataEncryptionKey key) {
    return Hmac(
      sha256,
      HEX.decode(key.hex),
    ).convert(utf8.encode(walletMetadataRootDTagDerivationContext)).toString();
  }
