    ...
    return BlocBuilder<BackupHealthReminderCubit, BackupHealthReminderState>(
      builder: (context, state) {
        ...
        return Stack(
          children: [
            ExcludeSemantics(
              key: const Key('backup_health_covered_content'),
              excluding: visible,
              child: widget.child,
            ),
...
class _BackupHealthReminderBlocker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned.fill(
      child: Semantics(
        key: const Key('backup_health_modal_semantics'),
        scopesRoute: true,
        namesRoute: true,
        explicitChildNodes: true,
        child: BlockSemantics(
          key: const Key('backup_health_modal_blocker'),
          child: PopScope(
            canPop: false,
            child: Material(
                        ...
                        children: [
                          ...
                          BBButton.big(
                            label: urgesPhysicalBackup
                                ? context
                                      .loc
                                      .backupHealthAddPhysicalBackupAction
