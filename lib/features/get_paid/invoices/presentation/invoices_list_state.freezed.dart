...
mixin _$InvoicesListState {
 ...
 List<Invoice> get invoices; InvoiceStatus? get statusFilter; bool get isLoading; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(invoices),statusFilter,isLoading,error);

@override
String toString() {
  return 'InvoicesListState(invoices: $invoices, statusFilter: $statusFilter, isLoading: $isLoading, error: $error)';
}
...
@useResult
$Res call({
 List<Invoice> invoices, InvoiceStatus? statusFilter, bool isLoading, String? error
});
...
/// Create a copy of InvoicesListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? invoices = null,Object? statusFilter = freezed,Object? isLoading = null,Object? error = freezed,}) {
  return _then(_self.copyWith(
invoices: null == invoices ? _self.invoices : invoices // ignore: cast_nullable_to_non_nullable
as List<Invoice>,statusFilter: freezed == statusFilter ? _self.statusFilter : statusFilter // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Invoice> invoices,  InvoiceStatus? statusFilter,  bool isLoading,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InvoicesListState() when $default != null:
return $default(_that.invoices,_that.statusFilter,_that.isLoading,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Invoice> invoices,  InvoiceStatus? statusFilter,  bool isLoading,  String? error)  $default,) {final _that = this;
switch (_that) {
case _InvoicesListState():
return $default(_that.invoices,_that.statusFilter,_that.isLoading,_that.error);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Invoice> invoices,  InvoiceStatus? statusFilter,  bool isLoading,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _InvoicesListState() when $default != null:
return $default(_that.invoices,_that.statusFilter,_that.isLoading,_that.error);case _:
  return null;
...
class _InvoicesListState extends InvoicesListState {
  const _InvoicesListState({final  List<Invoice> invoices = const [], this.statusFilter, this.isLoading = false, this.error}): _invoices = invoices,super._();
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_invoices),statusFilter,isLoading,error);
...
/// Create a copy of InvoicesListState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? invoices = null,Object? statusFilter = freezed,Object? isLoading = null,Object? error = freezed,}) {
