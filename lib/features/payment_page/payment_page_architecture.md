...
The unified wallet-backup coordinator observes the committed manifest change
and schedules publication when backup is enabled; Payment Page does not own or
manually invoke backup lifecycle APIs.
