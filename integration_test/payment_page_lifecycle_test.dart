...
// (tool/gen_all_test.dart skip set) because live app-startup timers/blocs make
// an app-process run non-deterministic. The deterministic gates for this
...
Future<void> main({bool isInitialized = false}) async {
  ...
  test('create -> backup -> recover restores wallet 102, and the '
    ...
    final recoveredPage = await locator<PaymentPageFacade>().ensurePageLive();
