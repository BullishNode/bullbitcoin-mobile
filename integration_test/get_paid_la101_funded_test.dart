...
// S-REAL-PROD-LA101-FUNDED: production Bullnym + real
...
// app's own wallet sync, then returns the funds through the app's
// Liquid-to-Lightning flow to the fixed Bullstr address. Every phase emits a
