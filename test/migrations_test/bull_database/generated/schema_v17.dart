...
class GetPaidSettings extends Table
    with TableInfo<GetPaidSettings, GetPaidSettingsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  GetPaidSettings(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> automatedBackupEnabled = GeneratedColumn<int>(
  ...
  backupDisclosureAcknowledged = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (backup_disclosure_acknowledged IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'get_paid_settings';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  GetPaidSettingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GetPaidSettingsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
      automatedBackupEnabled: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}automated_backup_enabled'],
      )!,
      backupDisclosureAcknowledged: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}backup_disclosure_acknowledged'],
      )!,
    );
  }

  @override
  GetPaidSettings createAlias(String alias) {
    return GetPaidSettings(attachedDatabase, alias);
  }
...
class GetPaidSettingsData extends DataClass
    implements Insertable<GetPaidSettingsData> {
  final int id;
  final int automatedBackupEnabled;
  final int backupDisclosureAcknowledged;
  const GetPaidSettingsData({
    required this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['automated_backup_enabled'] = Variable<int>(automatedBackupEnabled);
    map['backup_disclosure_acknowledged'] = Variable<int>(
      backupDisclosureAcknowledged,
    );
    return map;
  }

  GetPaidSettingsCompanion toCompanion(bool nullToAbsent) {
    return GetPaidSettingsCompanion(
      id: Value(id),
      automatedBackupEnabled: Value(automatedBackupEnabled),
      backupDisclosureAcknowledged: Value(backupDisclosureAcknowledged),
    );
  }

  factory GetPaidSettingsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return GetPaidSettingsData(
      id: serializer.fromJson<int>(json['id']),
      automatedBackupEnabled: serializer.fromJson<int>(
        json['automatedBackupEnabled'],
      ),
      backupDisclosureAcknowledged: serializer.fromJson<int>(
        json['backupDisclosureAcknowledged'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'automatedBackupEnabled': serializer.toJson<int>(automatedBackupEnabled),
      'backupDisclosureAcknowledged': serializer.toJson<int>(
        backupDisclosureAcknowledged,
      ),
    };
  }

  GetPaidSettingsData copyWith({
    int? id,
    int? automatedBackupEnabled,
    int? backupDisclosureAcknowledged,
  }) => GetPaidSettingsData(
    id: id ?? this.id,
    automatedBackupEnabled:
  ...
  GetPaidSettingsData copyWithCompanion(GetPaidSettingsCompanion data) {
    return GetPaidSettingsData(
      id: data.id.present ? data.id.value : this.id,
      automatedBackupEnabled: data.automatedBackupEnabled.present
          ? data.automatedBackupEnabled.value
          : this.automatedBackupEnabled,
      backupDisclosureAcknowledged: data.backupDisclosureAcknowledged.present
          ? data.backupDisclosureAcknowledged.value
          : this.backupDisclosureAcknowledged,
    );
  }

  @override
  String toString() {
    return (StringBuffer('GetPaidSettingsData(')
          ..write('id: $id, ')
          ..write('automatedBackupEnabled: $automatedBackupEnabled, ')
          ..write('backupDisclosureAcknowledged: $backupDisclosureAcknowledged')
          ..write(')'))
        .toString();
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, automatedBackupEnabled, backupDisclosureAcknowledged);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is GetPaidSettingsData &&
          other.id == this.id &&
          other.automatedBackupEnabled == this.automatedBackupEnabled &&
          other.backupDisclosureAcknowledged ==
              this.backupDisclosureAcknowledged);
}

class GetPaidSettingsCompanion extends UpdateCompanion<GetPaidSettingsData> {
  final Value<int> id;
  final Value<int> automatedBackupEnabled;
  final Value<int> backupDisclosureAcknowledged;
  const GetPaidSettingsCompanion({
    this.id = const Value.absent(),
    this.automatedBackupEnabled = const Value.absent(),
    this.backupDisclosureAcknowledged = const Value.absent(),
  });
  GetPaidSettingsCompanion.insert({
    this.id = const Value.absent(),
    this.automatedBackupEnabled = const Value.absent(),
    this.backupDisclosureAcknowledged = const Value.absent(),
  });
  static Insertable<GetPaidSettingsData> custom({
    Expression<int>? id,
    Expression<int>? automatedBackupEnabled,
    Expression<int>? backupDisclosureAcknowledged,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (automatedBackupEnabled != null)
        'automated_backup_enabled': automatedBackupEnabled,
      if (backupDisclosureAcknowledged != null)
        'backup_disclosure_acknowledged': backupDisclosureAcknowledged,
    });
  }

  GetPaidSettingsCompanion copyWith({
    Value<int>? id,
    Value<int>? automatedBackupEnabled,
    Value<int>? backupDisclosureAcknowledged,
  }) {
    return GetPaidSettingsCompanion(
      id: id ?? this.id,
      automatedBackupEnabled:
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (automatedBackupEnabled.present) {
      map['automated_backup_enabled'] = Variable<int>(
        automatedBackupEnabled.value,
      );
    }
    if (backupDisclosureAcknowledged.present) {
      map['backup_disclosure_acknowledged'] = Variable<int>(
        backupDisclosureAcknowledged.value,
      );
    }
    return map;
  }
  ...
  @override
  String toString() {
    return (StringBuffer('GetPaidSettingsCompanion(')
          ..write('id: $id, ')
          ..write('automatedBackupEnabled: $automatedBackupEnabled, ')
          ..write('backupDisclosureAcknowledged: $backupDisclosureAcknowledged')
          ..write(')'))
...
class WalletMetadataBackupStates extends Table
  ...
  late final GeneratedColumn<int>
  relayDisclosureAcknowledged = GeneratedColumn<int>(
    'relay_disclosure_acknowledged',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (relay_disclosure_acknowledged IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<int> lastAcceptedAt = GeneratedColumn<int>(
    'last_accepted_at',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<String> lastVerifiedRootEventId =
      GeneratedColumn<String>(
        'last_verified_root_event_id',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  late final GeneratedColumn<String> blockedRootEventId =
      GeneratedColumn<String>(
        'blocked_root_event_id',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  late final GeneratedColumn<int> blockedEventCreatedAt = GeneratedColumn<int>(
    'blocked_event_created_at',
    aliasedName,
    true,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
  ...
  late final GeneratedColumn<String> recoveryBlockedRootEventId =
      GeneratedColumn<String>(
        'recovery_blocked_root_event_id',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  late final GeneratedColumn<int> recoveryBlockedEventCreatedAt =
      GeneratedColumn<int>(
        'recovery_blocked_event_created_at',
        aliasedName,
        true,
        type: DriftSqlType.int,
        requiredDuringInsert: false,
  ...
  List<GeneratedColumn> get $columns => [
    ...
    blockedEventCreatedAt,
    blockedObservedAt,
    recoveryBlockedReason,
    recoveryBlockedRootEventId,
    recoveryBlockedSnapshotRevision,
    recoveryBlockedEventCreatedAt,
  ...
  WalletMetadataBackupStatesData map(
    ...
    return WalletMetadataBackupStatesData(
      ...
      relayDisclosureAcknowledged: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}relay_disclosure_acknowledged'],
      )!,
      ...
      lastAcceptedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}last_accepted_at'],
      ),
      lastVerifiedRootEventId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}last_verified_root_event_id'],
      ),
      ...
      blockedRootEventId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}blocked_root_event_id'],
      ),
      blockedEnvelopeVersion: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}blocked_envelope_version'],
      ),
      blockedEventCreatedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}blocked_event_created_at'],
      ),
      ...
      recoveryBlockedRootEventId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}recovery_blocked_root_event_id'],
      ),
      recoveryBlockedSnapshotRevision: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}recovery_blocked_snapshot_revision'],
      ),
      recoveryBlockedEventCreatedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}recovery_blocked_event_created_at'],
      ),
...
class WalletMetadataBackupStatesData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<int>(id);
    map['enabled'] = Variable<int>(enabled);
    map['relay_disclosure_acknowledged'] = Variable<int>(
      relayDisclosureAcknowledged,
    );
    ...
    if (!nullToAbsent || lastAcceptedAt != null) {
      map['last_accepted_at'] = Variable<int>(lastAcceptedAt);
    }
    if (!nullToAbsent || lastVerifiedRootEventId != null) {
      map['last_verified_root_event_id'] = Variable<String>(
        lastVerifiedRootEventId,
      );
    }
    ...
    if (!nullToAbsent || blockedRootEventId != null) {
      map['blocked_root_event_id'] = Variable<String>(blockedRootEventId);
    }
    if (!nullToAbsent || blockedEnvelopeVersion != null) {
      map['blocked_envelope_version'] = Variable<int>(blockedEnvelopeVersion);
    }
    if (!nullToAbsent || blockedEventCreatedAt != null) {
      map['blocked_event_created_at'] = Variable<int>(blockedEventCreatedAt);
    }
    ...
    if (!nullToAbsent || recoveryBlockedRootEventId != null) {
      map['recovery_blocked_root_event_id'] = Variable<String>(
        recoveryBlockedRootEventId,
      );
    }
    ...
    if (!nullToAbsent || recoveryBlockedEventCreatedAt != null) {
      map['recovery_blocked_event_created_at'] = Variable<int>(
        recoveryBlockedEventCreatedAt,
      );
    }
  ...
  WalletMetadataBackupStatesCompanion toCompanion(bool nullToAbsent) {
    return WalletMetadataBackupStatesCompanion(
      id: Value(id),
      enabled: Value(enabled),
      relayDisclosureAcknowledged: Value(relayDisclosureAcknowledged),
      dirty: Value(dirty),
      dirtyRevision: Value(dirtyRevision),
      lastAttemptedAt: lastAttemptedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(lastAttemptedAt),
      lastAcceptedAt: lastAcceptedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(lastAcceptedAt),
      lastVerifiedRootEventId: lastVerifiedRootEventId == null && nullToAbsent
          ? const Value.absent()
          : Value(lastVerifiedRootEventId),
      lastVerifiedSnapshotRevision:
      ...
      blockedReason: blockedReason == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedReason),
      blockedRootEventId: blockedRootEventId == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedRootEventId),
      blockedEnvelopeVersion: blockedEnvelopeVersion == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedEnvelopeVersion),
      blockedEventCreatedAt: blockedEventCreatedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(blockedEventCreatedAt),
      ...
      recoveryBlockedRootEventId:
          recoveryBlockedRootEventId == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedRootEventId),
      recoveryBlockedSnapshotRevision:
          recoveryBlockedSnapshotRevision == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedSnapshotRevision),
      recoveryBlockedEventCreatedAt:
          recoveryBlockedEventCreatedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(recoveryBlockedEventCreatedAt),
      recoveryBlockedObservedAt:
  ...
  factory WalletMetadataBackupStatesData.fromJson(
    ...
    return WalletMetadataBackupStatesData(
      id: serializer.fromJson<int>(json['id']),
      enabled: serializer.fromJson<int>(json['enabled']),
      relayDisclosureAcknowledged: serializer.fromJson<int>(
        json['relayDisclosureAcknowledged'],
      ),
      ...
      lastAcceptedAt: serializer.fromJson<int?>(json['lastAcceptedAt']),
      lastVerifiedRootEventId: serializer.fromJson<String?>(
        json['lastVerifiedRootEventId'],
      ),
      ...
      blockedRootEventId: serializer.fromJson<String?>(
        json['blockedRootEventId'],
      ),
      blockedEnvelopeVersion: serializer.fromJson<int?>(
        json['blockedEnvelopeVersion'],
      ),
      blockedEventCreatedAt: serializer.fromJson<int?>(
        json['blockedEventCreatedAt'],
      ),
      ...
      recoveryBlockedRootEventId: serializer.fromJson<String?>(
        json['recoveryBlockedRootEventId'],
      ),
      recoveryBlockedSnapshotRevision: serializer.fromJson<int?>(
        json['recoveryBlockedSnapshotRevision'],
      ),
      recoveryBlockedEventCreatedAt: serializer.fromJson<int?>(
        json['recoveryBlockedEventCreatedAt'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'enabled': serializer.toJson<int>(enabled),
      'relayDisclosureAcknowledged': serializer.toJson<int>(
        relayDisclosureAcknowledged,
      ),
      ...
      'lastAcceptedAt': serializer.toJson<int?>(lastAcceptedAt),
      'lastVerifiedRootEventId': serializer.toJson<String?>(
        lastVerifiedRootEventId,
      ),
      ...
      'blockedRootEventId': serializer.toJson<String?>(blockedRootEventId),
      'blockedEnvelopeVersion': serializer.toJson<int?>(blockedEnvelopeVersion),
      'blockedEventCreatedAt': serializer.toJson<int?>(blockedEventCreatedAt),
      'blockedObservedAt': serializer.toJson<int?>(blockedObservedAt),
      'recoveryBlockedReason': serializer.toJson<String?>(
        recoveryBlockedReason,
      ),
      'recoveryBlockedRootEventId': serializer.toJson<String?>(
        recoveryBlockedRootEventId,
      ),
      'recoveryBlockedSnapshotRevision': serializer.toJson<int?>(
        recoveryBlockedSnapshotRevision,
      ),
      'recoveryBlockedEventCreatedAt': serializer.toJson<int?>(
        recoveryBlockedEventCreatedAt,
      ),
  ...
  WalletMetadataBackupStatesData copyWith({
    int? id,
    int? enabled,
    int? relayDisclosureAcknowledged,
    int? dirty,
    int? dirtyRevision,
    Value<int?> lastAttemptedAt = const Value.absent(),
    Value<int?> lastAcceptedAt = const Value.absent(),
    Value<String?> lastVerifiedRootEventId = const Value.absent(),
    ...
    Value<String?> blockedRootEventId = const Value.absent(),
    Value<int?> blockedEnvelopeVersion = const Value.absent(),
    Value<int?> blockedEventCreatedAt = const Value.absent(),
    Value<int?> blockedObservedAt = const Value.absent(),
    Value<String?> recoveryBlockedReason = const Value.absent(),
    Value<String?> recoveryBlockedRootEventId = const Value.absent(),
    Value<int?> recoveryBlockedSnapshotRevision = const Value.absent(),
    Value<int?> recoveryBlockedEventCreatedAt = const Value.absent(),
    ...
    lastAttemptedAt: lastAttemptedAt.present
        ...
        : this.lastAttemptedAt,
    lastAcceptedAt: lastAcceptedAt.present
        ? lastAcceptedAt.value
        : this.lastAcceptedAt,
    lastVerifiedRootEventId: lastVerifiedRootEventId.present
        ? lastVerifiedRootEventId.value
        : this.lastVerifiedRootEventId,
    ...
    blockedReason: blockedReason.present
        ? blockedReason.value
        : this.blockedReason,
    blockedRootEventId: blockedRootEventId.present
        ? blockedRootEventId.value
        : this.blockedRootEventId,
    blockedEnvelopeVersion: blockedEnvelopeVersion.present
        ? blockedEnvelopeVersion.value
        : this.blockedEnvelopeVersion,
    blockedEventCreatedAt: blockedEventCreatedAt.present
        ? blockedEventCreatedAt.value
        : this.blockedEventCreatedAt,
    ...
    recoveryBlockedReason: recoveryBlockedReason.present
        ...
        : this.recoveryBlockedReason,
    recoveryBlockedRootEventId: recoveryBlockedRootEventId.present
        ? recoveryBlockedRootEventId.value
        : this.recoveryBlockedRootEventId,
    recoveryBlockedSnapshotRevision: recoveryBlockedSnapshotRevision.present
        ? recoveryBlockedSnapshotRevision.value
        : this.recoveryBlockedSnapshotRevision,
    recoveryBlockedEventCreatedAt: recoveryBlockedEventCreatedAt.present
        ? recoveryBlockedEventCreatedAt.value
        : this.recoveryBlockedEventCreatedAt,
  ...
  WalletMetadataBackupStatesData copyWithCompanion(
    ...
    return WalletMetadataBackupStatesData(
      id: data.id.present ? data.id.value : this.id,
      enabled: data.enabled.present ? data.enabled.value : this.enabled,
      relayDisclosureAcknowledged: data.relayDisclosureAcknowledged.present
          ? data.relayDisclosureAcknowledged.value
          : this.relayDisclosureAcknowledged,
      ...
      lastAttemptedAt: data.lastAttemptedAt.present
          ...
          : this.lastAttemptedAt,
      lastAcceptedAt: data.lastAcceptedAt.present
          ? data.lastAcceptedAt.value
          : this.lastAcceptedAt,
      lastVerifiedRootEventId: data.lastVerifiedRootEventId.present
          ? data.lastVerifiedRootEventId.value
          : this.lastVerifiedRootEventId,
      ...
      blockedReason: data.blockedReason.present
          ...
          : this.blockedReason,
      blockedRootEventId: data.blockedRootEventId.present
          ? data.blockedRootEventId.value
          : this.blockedRootEventId,
      blockedEnvelopeVersion: data.blockedEnvelopeVersion.present
          ? data.blockedEnvelopeVersion.value
          : this.blockedEnvelopeVersion,
      blockedEventCreatedAt: data.blockedEventCreatedAt.present
          ? data.blockedEventCreatedAt.value
          : this.blockedEventCreatedAt,
      ...
      recoveryBlockedReason: data.recoveryBlockedReason.present
          ...
          : this.recoveryBlockedReason,
      recoveryBlockedRootEventId: data.recoveryBlockedRootEventId.present
          ? data.recoveryBlockedRootEventId.value
          : this.recoveryBlockedRootEventId,
      recoveryBlockedSnapshotRevision:
          data.recoveryBlockedSnapshotRevision.present
          ? data.recoveryBlockedSnapshotRevision.value
          : this.recoveryBlockedSnapshotRevision,
      recoveryBlockedEventCreatedAt: data.recoveryBlockedEventCreatedAt.present
          ? data.recoveryBlockedEventCreatedAt.value
          : this.recoveryBlockedEventCreatedAt,
  ...
  String toString() {
    return (StringBuffer('WalletMetadataBackupStatesData(')
          ..write('id: $id, ')
          ..write('enabled: $enabled, ')
          ..write('relayDisclosureAcknowledged: $relayDisclosureAcknowledged, ')
          ..write('dirty: $dirty, ')
          ..write('dirtyRevision: $dirtyRevision, ')
          ..write('lastAttemptedAt: $lastAttemptedAt, ')
          ..write('lastAcceptedAt: $lastAcceptedAt, ')
          ..write('lastVerifiedRootEventId: $lastVerifiedRootEventId, ')
          ..write(
          ...
          ..write('blockedRootEventId: $blockedRootEventId, ')
          ..write('blockedEnvelopeVersion: $blockedEnvelopeVersion, ')
          ..write('blockedEventCreatedAt: $blockedEventCreatedAt, ')
          ..write('blockedObservedAt: $blockedObservedAt, ')
          ..write('recoveryBlockedReason: $recoveryBlockedReason, ')
          ..write('recoveryBlockedRootEventId: $recoveryBlockedRootEventId, ')
          ..write(
            'recoveryBlockedSnapshotRevision: $recoveryBlockedSnapshotRevision, ',
          )
          ..write(
            'recoveryBlockedEventCreatedAt: $recoveryBlockedEventCreatedAt, ',
          )
  ...
  bool operator ==(Object other) =>
      ...
      (other is WalletMetadataBackupStatesData &&
          other.id == this.id &&
          other.enabled == this.enabled &&
          other.relayDisclosureAcknowledged ==
              this.relayDisclosureAcknowledged &&
          other.dirty == this.dirty &&
          other.dirtyRevision == this.dirtyRevision &&
          other.lastAttemptedAt == this.lastAttemptedAt &&
          other.lastAcceptedAt == this.lastAcceptedAt &&
          other.lastVerifiedRootEventId == this.lastVerifiedRootEventId &&
          ...
          other.blockedRootEventId == this.blockedRootEventId &&
          other.blockedEnvelopeVersion == this.blockedEnvelopeVersion &&
          other.blockedEventCreatedAt == this.blockedEventCreatedAt &&
          other.blockedObservedAt == this.blockedObservedAt &&
          other.recoveryBlockedReason == this.recoveryBlockedReason &&
          other.recoveryBlockedRootEventId == this.recoveryBlockedRootEventId &&
          other.recoveryBlockedSnapshotRevision ==
              this.recoveryBlockedSnapshotRevision &&
          other.recoveryBlockedEventCreatedAt ==
              this.recoveryBlockedEventCreatedAt &&
...
class WalletMetadataBackupStatesCompanion
  ...
  final Value<int> id;
  final Value<int> enabled;
  final Value<int> relayDisclosureAcknowledged;
  final Value<int> dirty;
  final Value<int> dirtyRevision;
  final Value<int?> lastAttemptedAt;
  final Value<int?> lastAcceptedAt;
  final Value<String?> lastVerifiedRootEventId;
  ...
  const WalletMetadataBackupStatesCompanion({
    ...
    this.blockedRootEventId = const Value.absent(),
    this.blockedEnvelopeVersion = const Value.absent(),
    this.blockedEventCreatedAt = const Value.absent(),
    this.blockedObservedAt = const Value.absent(),
    this.recoveryBlockedReason = const Value.absent(),
    this.recoveryBlockedRootEventId = const Value.absent(),
    this.recoveryBlockedSnapshotRevision = const Value.absent(),
    this.recoveryBlockedEventCreatedAt = const Value.absent(),
  ...
  static Insertable<WalletMetadataBackupStatesData> custom({
    Expression<int>? id,
    Expression<int>? enabled,
    Expression<int>? relayDisclosureAcknowledged,
    Expression<int>? dirty,
    Expression<int>? dirtyRevision,
    Expression<int>? lastAttemptedAt,
    Expression<int>? lastAcceptedAt,
    Expression<String>? lastVerifiedRootEventId,
    ...
    Expression<String>? blockedRootEventId,
    Expression<int>? blockedEnvelopeVersion,
    Expression<int>? blockedEventCreatedAt,
    Expression<int>? blockedObservedAt,
    Expression<String>? recoveryBlockedReason,
    Expression<String>? recoveryBlockedRootEventId,
    Expression<int>? recoveryBlockedSnapshotRevision,
    Expression<int>? recoveryBlockedEventCreatedAt,
    Expression<int>? recoveryBlockedObservedAt,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (enabled != null) 'enabled': enabled,
      if (relayDisclosureAcknowledged != null)
        'relay_disclosure_acknowledged': relayDisclosureAcknowledged,
      if (dirty != null) 'dirty': dirty,
      if (dirtyRevision != null) 'dirty_revision': dirtyRevision,
      if (lastAttemptedAt != null) 'last_attempted_at': lastAttemptedAt,
      if (lastAcceptedAt != null) 'last_accepted_at': lastAcceptedAt,
      if (lastVerifiedRootEventId != null)
        'last_verified_root_event_id': lastVerifiedRootEventId,
      ...
      if (blockedRootEventId != null)
        'blocked_root_event_id': blockedRootEventId,
      if (blockedEnvelopeVersion != null)
        'blocked_envelope_version': blockedEnvelopeVersion,
      if (blockedEventCreatedAt != null)
        'blocked_event_created_at': blockedEventCreatedAt,
      ...
      if (recoveryBlockedRootEventId != null)
        'recovery_blocked_root_event_id': recoveryBlockedRootEventId,
      if (recoveryBlockedSnapshotRevision != null)
        'recovery_blocked_snapshot_revision': recoveryBlockedSnapshotRevision,
      if (recoveryBlockedEventCreatedAt != null)
        'recovery_blocked_event_created_at': recoveryBlockedEventCreatedAt,
  ...
  WalletMetadataBackupStatesCompanion copyWith({
    Value<int>? id,
    Value<int>? enabled,
    Value<int>? relayDisclosureAcknowledged,
    Value<int>? dirty,
    Value<int>? dirtyRevision,
    Value<int?>? lastAttemptedAt,
    Value<int?>? lastAcceptedAt,
    Value<String?>? lastVerifiedRootEventId,
    ...
    Value<String?>? blockedRootEventId,
    Value<int?>? blockedEnvelopeVersion,
    Value<int?>? blockedEventCreatedAt,
    Value<int?>? blockedObservedAt,
    Value<String?>? recoveryBlockedReason,
    Value<String?>? recoveryBlockedRootEventId,
    Value<int?>? recoveryBlockedSnapshotRevision,
    Value<int?>? recoveryBlockedEventCreatedAt,
    ...
    return WalletMetadataBackupStatesCompanion(
      ...
      lastVerifiedRootEventId:
          lastVerifiedRootEventId ?? this.lastVerifiedRootEventId,
      lastVerifiedSnapshotRevision:
      ...
      blockedRootEventId: blockedRootEventId ?? this.blockedRootEventId,
      blockedEnvelopeVersion:
          blockedEnvelopeVersion ?? this.blockedEnvelopeVersion,
      blockedEventCreatedAt:
          blockedEventCreatedAt ?? this.blockedEventCreatedAt,
      blockedObservedAt: blockedObservedAt ?? this.blockedObservedAt,
      recoveryBlockedReason:
          recoveryBlockedReason ?? this.recoveryBlockedReason,
      recoveryBlockedRootEventId:
          recoveryBlockedRootEventId ?? this.recoveryBlockedRootEventId,
      recoveryBlockedSnapshotRevision:
          recoveryBlockedSnapshotRevision ??
          this.recoveryBlockedSnapshotRevision,
      recoveryBlockedEventCreatedAt:
          recoveryBlockedEventCreatedAt ?? this.recoveryBlockedEventCreatedAt,
      recoveryBlockedObservedAt:
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (relayDisclosureAcknowledged.present) {
      map['relay_disclosure_acknowledged'] = Variable<int>(
        relayDisclosureAcknowledged.value,
      );
    }
    if (dirty.present) {
    ...
    if (lastAcceptedAt.present) {
      map['last_accepted_at'] = Variable<int>(lastAcceptedAt.value);
    }
    if (lastVerifiedRootEventId.present) {
      map['last_verified_root_event_id'] = Variable<String>(
        lastVerifiedRootEventId.value,
      );
    }
    ...
    if (blockedRootEventId.present) {
      map['blocked_root_event_id'] = Variable<String>(blockedRootEventId.value);
    }
    ...
    if (blockedEventCreatedAt.present) {
      map['blocked_event_created_at'] = Variable<int>(
        blockedEventCreatedAt.value,
      );
    }
    ...
    if (recoveryBlockedRootEventId.present) {
      map['recovery_blocked_root_event_id'] = Variable<String>(
        recoveryBlockedRootEventId.value,
      );
    }
    ...
    if (recoveryBlockedEventCreatedAt.present) {
      map['recovery_blocked_event_created_at'] = Variable<int>(
        recoveryBlockedEventCreatedAt.value,
      );
    }
...
class DatabaseAtV17 extends GeneratedDatabase {
  ...
  late final GetPaidSettings getPaidSettings = GetPaidSettings(this);
