...
class PaymentRecoveries extends Table
    with TableInfo<PaymentRecoveries, PaymentRecoveriesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PaymentRecoveries(this.attachedDatabase, [this._alias]);
  ...
  late final GeneratedColumn<String> nym = GeneratedColumn<String>(
    'nym',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<String> lockupAddress = GeneratedColumn<String>(
    'lockup_address',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<int> fiatAmountMinor = GeneratedColumn<int>(
    'fiat_amount_minor',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> detectedAtUnix = GeneratedColumn<int>(
    'detected_at_unix',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> lastAttemptAtUnix = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> acknowledged = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (acknowledged IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'payment_recoveries';
  @override
  Set<GeneratedColumn> get $primaryKey => {invoiceId};
  @override
  PaymentRecoveriesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PaymentRecoveriesData(
      invoiceId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}invoice_id'],
      )!,
      nym: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}nym'],
      )!,
      ...
      lockupAddress: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}lockup_address'],
      ),
      amountSat: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}amount_sat'],
      ),
      fiatCurrency: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}fiat_currency'],
      ),
      fiatAmountMinor: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}fiat_amount_minor'],
      ),
      detectedAtUnix: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}detected_at_unix'],
      )!,
      lastAttemptAtUnix: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}last_attempt_at_unix'],
      ),
  ...
  @override
  PaymentRecoveries createAlias(String alias) {
    return PaymentRecoveries(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(invoice_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class PaymentRecoveriesData extends DataClass
    implements Insertable<PaymentRecoveriesData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || lockupAddress != null) {
      map['lockup_address'] = Variable<String>(lockupAddress);
    }
    if (!nullToAbsent || amountSat != null) {
      map['amount_sat'] = Variable<int>(amountSat);
    }
    if (!nullToAbsent || fiatCurrency != null) {
      map['fiat_currency'] = Variable<String>(fiatCurrency);
    }
    if (!nullToAbsent || fiatAmountMinor != null) {
      map['fiat_amount_minor'] = Variable<int>(fiatAmountMinor);
    }
    map['detected_at_unix'] = Variable<int>(detectedAtUnix);
    if (!nullToAbsent || lastAttemptAtUnix != null) {
      map['last_attempt_at_unix'] = Variable<int>(lastAttemptAtUnix);
    }
  ...
  PaymentRecoveriesCompanion toCompanion(bool nullToAbsent) {
    return PaymentRecoveriesCompanion(
      ...
      refundTxid: refundTxid == null && nullToAbsent
          ? const Value.absent()
          : Value(refundTxid),
      lockupAddress: lockupAddress == null && nullToAbsent
          ? const Value.absent()
          : Value(lockupAddress),
      amountSat: amountSat == null && nullToAbsent
          ? const Value.absent()
          : Value(amountSat),
      fiatCurrency: fiatCurrency == null && nullToAbsent
          ? const Value.absent()
          : Value(fiatCurrency),
      fiatAmountMinor: fiatAmountMinor == null && nullToAbsent
          ? const Value.absent()
          : Value(fiatAmountMinor),
      detectedAtUnix: Value(detectedAtUnix),
      lastAttemptAtUnix: lastAttemptAtUnix == null && nullToAbsent
          ? const Value.absent()
          : Value(lastAttemptAtUnix),
  ...
  factory PaymentRecoveriesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return PaymentRecoveriesData(
      ...
      nym: serializer.fromJson<String>(json['nym']),
      state: serializer.fromJson<String>(json['state']),
      refundAddress: serializer.fromJson<String?>(json['refundAddress']),
      refundTxid: serializer.fromJson<String?>(json['refundTxid']),
      lockupAddress: serializer.fromJson<String?>(json['lockupAddress']),
      amountSat: serializer.fromJson<int?>(json['amountSat']),
      fiatCurrency: serializer.fromJson<String?>(json['fiatCurrency']),
      fiatAmountMinor: serializer.fromJson<int?>(json['fiatAmountMinor']),
      detectedAtUnix: serializer.fromJson<int>(json['detectedAtUnix']),
      lastAttemptAtUnix: serializer.fromJson<int?>(json['lastAttemptAtUnix']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'nym': serializer.toJson<String>(nym),
      'state': serializer.toJson<String>(state),
      'refundAddress': serializer.toJson<String?>(refundAddress),
      'refundTxid': serializer.toJson<String?>(refundTxid),
      'lockupAddress': serializer.toJson<String?>(lockupAddress),
      'amountSat': serializer.toJson<int?>(amountSat),
      'fiatCurrency': serializer.toJson<String?>(fiatCurrency),
      'fiatAmountMinor': serializer.toJson<int?>(fiatAmountMinor),
      'detectedAtUnix': serializer.toJson<int>(detectedAtUnix),
      'lastAttemptAtUnix': serializer.toJson<int?>(lastAttemptAtUnix),
  ...
  PaymentRecoveriesData copyWith({
    String? invoiceId,
    String? nym,
    String? state,
    Value<String?> refundAddress = const Value.absent(),
    Value<String?> refundTxid = const Value.absent(),
    Value<String?> lockupAddress = const Value.absent(),
    Value<int?> amountSat = const Value.absent(),
    Value<String?> fiatCurrency = const Value.absent(),
    Value<int?> fiatAmountMinor = const Value.absent(),
    int? detectedAtUnix,
    Value<int?> lastAttemptAtUnix = const Value.absent(),
    int? attemptCount,
    Value<String?> lastErrorCode = const Value.absent(),
    int? acknowledged,
  }) => PaymentRecoveriesData(
    ...
    refundAddress: refundAddress.present
        ...
        : this.refundAddress,
    refundTxid: refundTxid.present ? refundTxid.value : this.refundTxid,
    lockupAddress: lockupAddress.present
        ? lockupAddress.value
        : this.lockupAddress,
    amountSat: amountSat.present ? amountSat.value : this.amountSat,
    fiatCurrency: fiatCurrency.present ? fiatCurrency.value : this.fiatCurrency,
    fiatAmountMinor: fiatAmountMinor.present
        ? fiatAmountMinor.value
        : this.fiatAmountMinor,
    detectedAtUnix: detectedAtUnix ?? this.detectedAtUnix,
    lastAttemptAtUnix: lastAttemptAtUnix.present
        ? lastAttemptAtUnix.value
        : this.lastAttemptAtUnix,
  ...
  PaymentRecoveriesData copyWithCompanion(PaymentRecoveriesCompanion data) {
    return PaymentRecoveriesData(
      invoiceId: data.invoiceId.present ? data.invoiceId.value : this.invoiceId,
      nym: data.nym.present ? data.nym.value : this.nym,
      ...
      refundTxid: data.refundTxid.present
          ? data.refundTxid.value
          : this.refundTxid,
      lockupAddress: data.lockupAddress.present
          ? data.lockupAddress.value
          : this.lockupAddress,
      amountSat: data.amountSat.present ? data.amountSat.value : this.amountSat,
      fiatCurrency: data.fiatCurrency.present
          ? data.fiatCurrency.value
          : this.fiatCurrency,
      fiatAmountMinor: data.fiatAmountMinor.present
          ? data.fiatAmountMinor.value
          : this.fiatAmountMinor,
      detectedAtUnix: data.detectedAtUnix.present
          ? data.detectedAtUnix.value
          : this.detectedAtUnix,
      lastAttemptAtUnix: data.lastAttemptAtUnix.present
          ? data.lastAttemptAtUnix.value
          : this.lastAttemptAtUnix,
  ...
  @override
  String toString() {
    return (StringBuffer('PaymentRecoveriesData(')
          ..write('invoiceId: $invoiceId, ')
          ..write('nym: $nym, ')
          ..write('state: $state, ')
          ..write('refundAddress: $refundAddress, ')
          ..write('refundTxid: $refundTxid, ')
          ..write('lockupAddress: $lockupAddress, ')
          ..write('amountSat: $amountSat, ')
          ..write('fiatCurrency: $fiatCurrency, ')
          ..write('fiatAmountMinor: $fiatAmountMinor, ')
          ..write('detectedAtUnix: $detectedAtUnix, ')
          ..write('lastAttemptAtUnix: $lastAttemptAtUnix, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PaymentRecoveriesData &&
          other.invoiceId == this.invoiceId &&
          other.nym == this.nym &&
          other.state == this.state &&
          other.refundAddress == this.refundAddress &&
          other.refundTxid == this.refundTxid &&
          other.lockupAddress == this.lockupAddress &&
          other.amountSat == this.amountSat &&
          other.fiatCurrency == this.fiatCurrency &&
          other.fiatAmountMinor == this.fiatAmountMinor &&
          other.detectedAtUnix == this.detectedAtUnix &&
          other.lastAttemptAtUnix == this.lastAttemptAtUnix &&
          other.attemptCount == this.attemptCount &&
          other.lastErrorCode == this.lastErrorCode &&
          other.acknowledged == this.acknowledged);
}

class PaymentRecoveriesCompanion
    extends UpdateCompanion<PaymentRecoveriesData> {
  final Value<String> invoiceId;
  final Value<String> nym;
  final Value<String> state;
  final Value<String?> refundAddress;
  final Value<String?> refundTxid;
  final Value<String?> lockupAddress;
  final Value<int?> amountSat;
  final Value<String?> fiatCurrency;
  final Value<int?> fiatAmountMinor;
  final Value<int> detectedAtUnix;
  final Value<int?> lastAttemptAtUnix;
  final Value<int> attemptCount;
  final Value<String?> lastErrorCode;
  final Value<int> acknowledged;
  final Value<int> rowid;
  const PaymentRecoveriesCompanion({
    this.invoiceId = const Value.absent(),
    this.nym = const Value.absent(),
    this.state = const Value.absent(),
    this.refundAddress = const Value.absent(),
    this.refundTxid = const Value.absent(),
    this.lockupAddress = const Value.absent(),
    this.amountSat = const Value.absent(),
    this.fiatCurrency = const Value.absent(),
    this.fiatAmountMinor = const Value.absent(),
    this.detectedAtUnix = const Value.absent(),
    this.lastAttemptAtUnix = const Value.absent(),
    this.attemptCount = const Value.absent(),
    this.lastErrorCode = const Value.absent(),
    this.acknowledged = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  PaymentRecoveriesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       state = Value(state),
       detectedAtUnix = Value(detectedAtUnix);
  static Insertable<PaymentRecoveriesData> custom({
    Expression<String>? invoiceId,
    Expression<String>? nym,
    Expression<String>? state,
    Expression<String>? refundAddress,
    Expression<String>? refundTxid,
    Expression<String>? lockupAddress,
    Expression<int>? amountSat,
    Expression<String>? fiatCurrency,
    Expression<int>? fiatAmountMinor,
    Expression<int>? detectedAtUnix,
    Expression<int>? lastAttemptAtUnix,
    ...
    return RawValuesInsertable({
      ...
      if (refundAddress != null) 'refund_address': refundAddress,
      if (refundTxid != null) 'refund_txid': refundTxid,
      if (lockupAddress != null) 'lockup_address': lockupAddress,
      if (amountSat != null) 'amount_sat': amountSat,
      if (fiatCurrency != null) 'fiat_currency': fiatCurrency,
      if (fiatAmountMinor != null) 'fiat_amount_minor': fiatAmountMinor,
      if (detectedAtUnix != null) 'detected_at_unix': detectedAtUnix,
      if (lastAttemptAtUnix != null) 'last_attempt_at_unix': lastAttemptAtUnix,
  ...
  PaymentRecoveriesCompanion copyWith({
    Value<String>? invoiceId,
    Value<String>? nym,
    Value<String>? state,
    Value<String?>? refundAddress,
    Value<String?>? refundTxid,
    Value<String?>? lockupAddress,
    Value<int?>? amountSat,
    Value<String?>? fiatCurrency,
    Value<int?>? fiatAmountMinor,
    Value<int>? detectedAtUnix,
    Value<int?>? lastAttemptAtUnix,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (nym.present) {
      map['nym'] = Variable<String>(nym.value);
    }
    if (state.present) {
    ...
    if (lockupAddress.present) {
      map['lockup_address'] = Variable<String>(lockupAddress.value);
    }
    if (amountSat.present) {
      map['amount_sat'] = Variable<int>(amountSat.value);
    }
    ...
    if (fiatAmountMinor.present) {
      map['fiat_amount_minor'] = Variable<int>(fiatAmountMinor.value);
    }
    if (detectedAtUnix.present) {
      map['detected_at_unix'] = Variable<int>(detectedAtUnix.value);
    }
    if (lastAttemptAtUnix.present) {
      map['last_attempt_at_unix'] = Variable<int>(lastAttemptAtUnix.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('PaymentRecoveriesCompanion(')
          ..write('invoiceId: $invoiceId, ')
          ..write('nym: $nym, ')
          ..write('state: $state, ')
          ..write('refundAddress: $refundAddress, ')
...
class DatabaseAtV17 extends GeneratedDatabase {
  ...
  late final PaymentRecoveries paymentRecoveries = PaymentRecoveries(this);
  @override
