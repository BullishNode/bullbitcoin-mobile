...
void main() {
  ...
  group('PrivateInvoiceLink', () {
    ...
    test('requires the response route to match the requested nym', () {
      for (final mismatch in [
        ...
        (
          expectedNym: 'alice',
          invoiceUrl: 'https://pay2.bull-wallet.com/bob/i/inv-1',
        ),
      ]) {
        expect(
          () => PrivateInvoiceLink.fromServer(
            invoiceUrl: mismatch.invoiceUrl,
            expectedInvoiceId: invoiceId,
            viewingKey: 'A' * 43,
            expectedOrigin: origin,
            expectedNym: mismatch.expectedNym,
          ),
          throwsArgumentError,
        );
      }
