  ...
  group('frozen wire values', () {
    ...
    test('frozen wire value: BIP85 reservation owner names', () {
      expect(Bip85ReservationOwner.values, [
        ...
        Bip85ReservationOwner.walletBackup,
      ]);
      ...
      expect(Bip85ReservationOwner.walletBackup.name, 'walletBackup');
    });
    ...
    test('frozen wire value: BIP85 reservation purpose names', () {
      expect(Bip85ReservationPurpose.values, [
        ...
        Bip85ReservationPurpose.backupEncryptionKey,
      ]);
      ...
      expect(
        Bip85ReservationPurpose.backupEncryptionKey.name,
        'backupEncryptionKey',
      );
    });
