...
void main() {
  ...
  test('rejects more entries than the registry reserves', () {
    // Every valid entry maps to a distinct reservation, so a file carrying more entries than the registry's current ten reservations is bounded before per-entry validation runs.
