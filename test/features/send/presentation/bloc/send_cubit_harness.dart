...
class SendCubitHarness {
  ...
  final GetSwapLimitsUsecase _getSwapLimits = _MockGetSwapLimitsUsecase();
  ...
  final UpdateSendSwapLockupFeesUsecase _updateSendSwapLockupFees =
  ...
  SendCubit createCubit() {
    return SendCubit(
      ...
      getSwapLimitsUsecase: _getSwapLimits,
      ...
      updateSendSwapLockupFeesUsecase: _updateSendSwapLockupFees,
