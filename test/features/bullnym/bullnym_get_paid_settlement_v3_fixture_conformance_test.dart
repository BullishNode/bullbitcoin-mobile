...
// v3 contract conformance: the MOBILE-side v3 fixture ANTICIPATES the bullnym
// merchant-accounting contract (~/GETPAID_ACCOUNTING_PLAN.md). It adds R1
...
// in the LEG currency). This fixture is to be REPLACED byte-identical when the
// server PR lands. The parser must read the new fields where present, keep the
// legacy/bitcoin rows unchanged, and never conflate the face currency with the
// leg currency.
void main() {
  test('parses the anticipated v3 accounting fixture through the real model', () {
    final raw = File(
