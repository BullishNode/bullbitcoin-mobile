...
class _MockRecoverRemoteKeychainUsecase extends Mock
...
void main() {
  ...
  late _MockRecoverRemoteKeychainUsecase recoverRemoteKeychain;
  ...
  setUp(() {
    ...
    recoverRemoteKeychain = _MockRecoverRemoteKeychainUsecase();
    when(
  ...
  test(
    ...
    () async {
      ...
      // The fork hands the created wallet ids to optional manifest recovery
      // before signalling success, so the id has to answer here too.
